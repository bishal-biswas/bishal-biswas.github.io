...
// Section heading and intro for the services block on the homepage. The
// services themselves are Markdown entries in src/content/services/ (the
// `services` content collection), editable under Services in the CMS.
