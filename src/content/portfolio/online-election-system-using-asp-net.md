...
The project is built using <b>ASP.NET with C#</b>, integrated with <b>MS SQL Server</b> for database management. Additional tools such as <b>HTML, CSS, JavaScript, and jQuery</b> enhance the frontend experience, making the system user-friendly and visually appealing. Email integration is implemented to provide timely updates to voters and candidates.
